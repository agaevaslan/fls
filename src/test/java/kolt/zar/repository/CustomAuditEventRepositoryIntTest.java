package kolt.zar.repository;

import kolt.zar.FslApp;
import kolt.zar.config.Constants;
import kolt.zar.config.audit.AuditEventConverter;
import kolt.zar.domain.PersistentAuditEvent;
...
import static kolt.zar.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
